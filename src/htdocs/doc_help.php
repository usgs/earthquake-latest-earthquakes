...
<dl class="vertical">
  ...
  <dt>Terrain Map</dt>
  <dd>
      A distinctive, highly detailed, basemap that reflects National
      Geographic's cartographic style. The terrain map is designed to be
      aesthetically pleasing.
  </dd>
  <dt>Street Map</dt>
  <dd>
      A hybrid view, that provides detailed street and highway-level data on
      top of terrain data.
  </dd>
  <dt>Satellite Map</dt>
  <dd>
  ...
  <dd>
      An overlay depicting plate boundaries.  Plate boundaries are displayed
      as bold red lines.
  </dd>
  <dt>U.S. Faults</dt>
  <dd>
      An overlay depicting U.S. Faults.  U.S. Faults are displayed as thin red
      lines, and the fault names display as hover text.
  </dd>
  <dt>U.S. Hazards</dt>
  <dd>
      The U.S. Hazards overlay defines areas of shaking.  Red characterizes
      areas in the U.S. with the highest levels of shaking, while blue
      distinguishes areas with the lowest levels of shaking.
  </dd>
</dl>
