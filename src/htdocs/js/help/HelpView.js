    ...
    buf.push(
      ...
      '<ul class="no-style separator">',
        ...
        '<li>',
          ...
          '<p>',
            'Clicking the map icon in the top right corner will load the map.',
          '</p>',
        '</li>',
        '<li>',
        ...
        '<li>',
          ...
          '<p>',
            'Clicking the help icon in the top right corner loads this page.',
          '</p>',
        '</li>',
      ...
      '<ul class="partners no-style separator">',
        ...
        '<li class="gsn">',
          '<a href="/monitoring/gsn/" title="Global Seismographic Network">',
            ...
            '<img width="25" height="30" src="', gsnLogo, '" alt="GSN"/>',
          '</a>',
        '</li>',
        '<li class="nehrp">',
